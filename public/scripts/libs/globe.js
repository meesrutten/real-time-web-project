...
DAT.Globe = function(container, colorFn) {
  ...
  function init() {
    ...
    uniforms['texture'].texture = THREE.ImageUtils.loadTexture(imgDir+'world-2' +
        '.jpg');
  ...
  // }
  function removeMesh() {
    var objsToRemove = _.rest(scene.children, 2);
